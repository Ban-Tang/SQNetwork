...
FOUNDATION_EXPORT NSString *const SQRequestValidationErrorDomain;

enum {
    SQRequestValidationErrorInvalidStatusCode = -8,
    SQRequestValidationErrorInvalidJSONFormat = -9,
};
 ...
 */
typedef NS_ENUM(NSInteger, SQResponseSerializerType) {
    SQResponseSerializerTypeHTTP, // NSData type
    SQResponseSerializerTypeJSON, // JSON object type
    SQResponseSerializerTypeXMLParser,  // NSXMLParser type
};
...
/**
 Optional CDN URL for request. Default is nil.
 */
- (NSString *)cdnUrl;
...
/**
 ...
 Default is nil.
 */
@property (nonatomic, weak, nullable) id<SQRequestDelegate> delegate;
 ...
 */
@property (nonatomic, copy, nullable) SQRequestCompletionBlock successCompletionBlock;
...
/**
 ...
 will be called on the main queue.
 */
@property (nonatomic, copy, nullable) SQRequestCompletionBlock failureCompletionBlock;
...
/**
 You can use this block to track the download progress. See also `resumableDownloadPath` of SQRequest.
 */
@property (nonatomic, copy, nullable) AFURLSessionTaskProgressBlock resumableDownloadProgressBlock;

/**
 The priority of the request. Effective only on iOS 8+. Default is `SQRequestPriorityDefault`.
 */
@property (nonatomic) SQRequestPriority requestPriority;


/**
 Set completion callbacks
 */
- (void)setCompletionBlockWithSuccess:(nullable SQRequestCompletionBlock)success
 ...
 */
- (void)startWithCompletionBlockWithSuccess:(nullable SQRequestCompletionBlock)success
                                    failure:(nullable SQRequestCompletionBlock)failure;
...
/**
 ...
 `SQResponseSerializerType`. Note this value can be nil if request failed.
...
/**
 If you use `SQResponseSerializerTypeJSON`, this is a convenience (and sematic) getter
